...
with open('/home/simonettos/comparison/phi-2/phi_train_fine_tuned_concatenated.pickle', 'rb') as f1:
    balanced = pickle.load(f1)

with open('/home/simonettos/comparison/phi-2/phi_test_fine_tuned_0.pickle', 'rb') as f2:
    unbalanced = pickle.load(f2)

train = np.array([item['cve_description_phi_last'] for item in balanced if item['cwe'] != 'None'])
...
X_test = np.array([item['cve_description_phi_last'] for item in unbalanced if item['cwe'] != 'None'])
...
for i, model in enumerate(models):
    ...
    model.save(f'/home/simonettos/comparison/phi-2/paper/ft/best_model_descr_{i+1}.h5')
...
print("\nAveraged Classification Report (Phi-2_ft):\n", classification_report(y_test, y_pred_avg_original, digits=4))

# Save the label encoder
joblib.dump(label_encoder_train, '/home/simonettos/comparison/phi-2/paper/ft/label_encoder_train_descr.joblib')