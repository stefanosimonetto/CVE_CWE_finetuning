...
for i, model in enumerate(models):
    ...
    model.save(f'/home/simonettos/comparison/phi-2/paper/descr/best_model_descr_{i+1}.h5')
...
print("\nAveraged Classification Report (phi-2_descr):\n", classification_report(y_test, y_pred_avg_original, digits=4))

# Save the label encoder
joblib.dump(label_encoder_train, '/home/simonettos/comparison/phi-2/paper/descr/label_encoder_train_descr.joblib')