...
train = np.array([item['processed_description_llama_last'] for item in balanced if item['cwe'] != 'None'])
...
X_test = np.array([item['processed_description_llama_last'] for item in unbalanced if item['cwe'] != 'None'])
...
for i, model in enumerate(models):
    ...
    model.save(f'/home/simonettos/comparison/llama/paper/nlp/best_model_descr_{i+1}.h5')
...
print("\nAveraged Classification Report (LLAMA-nlp):\n", classification_report(y_test, y_pred_avg_original, digits=4))

# Save the label encoder
joblib.dump(label_encoder_train, '/home/simonettos/comparison/lama/paper/nlp/label_encoder_train_descr.joblib')