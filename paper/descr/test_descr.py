...
with open('/home/simonettos/comparison/llama/llama_train.pickle', 'rb') as f1:
    balanced = pickle.load(f1)

with open('/home/simonettos/comparison/llama/llama_test_0.pickle', 'rb') as f2:
...
for i, model in enumerate(models):
    ...
    model.save(f'/home/simonettos/comparison/llama/paper/descr/best_model_descr_{i+1}.h5')
...
print("\nAveraged Classification Report (LLAMA-description):\n", classification_report(y_test, y_pred_avg_original, digits=4))

# Save the label encoder
joblib.dump(label_encoder_train, '/home/simonettos/comparison/llama/paper/descr/label_encoder_train_descr.joblib')